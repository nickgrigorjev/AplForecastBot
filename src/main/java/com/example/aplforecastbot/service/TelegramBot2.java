...
////        System.out.println("Здесь находится Text" + update.getMessage().getText());
////        EditMessageCaption caption = new EditMessageCaption();
////        System.out.println("Здесь находится Text" + caption.getCaption());
////        Message msg = update.getMessage();
////        if(msg.getCaption().contains("Результаты")){
////            System.out.println("MediaGroupId = "+update.getMessage().getMediaGroupId());
////        }
////
...
////            System.out.println("MessageId - "+update.getMessage().getMessageId());
////            System.out.println("Text "+update.getMessage().getText());
////        }else if(update.getMessage().hasDocument()){
////            System.out.println("Найдено фото в update");
////            System.out.println("MessageId - " + update.getMessage().getMessageId());
////        }
////    }
//
...
////            inputMedia.get(0).setMediaName(String.valueOf(caption));
//        }
//        editMessageMedia.setMedia(inputMedia.get(0));
//
//        SendMediaGroup sendMediaGroup = new SendMediaGroup();
//        sendMediaGroup.setMedias(inputMedia);
//        sendMediaGroup.setChatId(String.valueOf(chatId));
//        System.out.println("editMessageMedia.getChatId - "+editMessageMedia.getChatId());
//        System.out.println("editMessageMedia.getChatId - "+editMessageMedia.getMessageId());
//
//        try{
...
//    }
//
////    private void sendEditedKeyboard(long chatId){
////        EditMessageReplyMarkup editMessageReplyMarkup = new EditMessageReplyMarkup();
////        editMessageReplyMarkup.setReplyMarkup();
////    }
//
////    private void sendFormForForecast(long chatId, String textToSend){
////        SendMessage message = new SendMessage();
////        message.setChatId(String.valueOf(chatId));
////        message.setText(textToSend);
////        Timestamp currentTime = new Timestamp(System.currentTimeMillis());
////        System.out.println(roundRepository.findCurrentRound(currentTime));
////        System.out.println(roundRepository.findCurrentRound(currentTime));
////        List<MatchResult> matchResultList = new ArrayList<>(matchResultRepository.findAllByNumberOfRound(roundRepository.findCurrentRound(currentTime)));
...
////        KeyboardRow row = new KeyboardRow();
////
////        KeyboardButton home0=new KeyboardButton(matchResultList.get(0).getHt());
////        row.add(home0);
////        row.add(new KeyboardButton(String.valueOf(matchResultList.get(0).getHtGoals())));
////        row.add(new KeyboardButton(":"));
////        row.add(new KeyboardButton(String.valueOf(matchResultList.get(0).getGtGoals())));
////        row.add(new KeyboardButton(matchResultList.get(0).getGt()));
////        keyboardRows.add(row);
////
////        row = new KeyboardRow();
////        row.add(new KeyboardButton(matchResultList.get(1).getHt()));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(":"));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(matchResultList.get(1).getGt()));
////        keyboardRows.add(row);
////
////        row = new KeyboardRow();
////        row.add(new KeyboardButton(matchResultList.get(2).getHt()));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(":"));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(matchResultList.get(2).getGt()));
////        keyboardRows.add(row);
////
////        row = new KeyboardRow();
////        row.add(new KeyboardButton(matchResultList.get(3).getHt()));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(":"));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(matchResultList.get(3).getGt()));
////        keyboardRows.add(row);
////
////        row = new KeyboardRow();
////        row.add(new KeyboardButton(matchResultList.get(4).getHt()));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(":"));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(matchResultList.get(4).getGt()));
////        keyboardRows.add(row);
////
////        row = new KeyboardRow();
////        row.add(new KeyboardButton(matchResultList.get(5).getHt()));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(":"));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(matchResultList.get(5).getGt()));
////        keyboardRows.add(row);
////
////        row = new KeyboardRow();
////        row.add(new KeyboardButton(matchResultList.get(6).getHt()));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(":"));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(matchResultList.get(6).getGt()));
////        keyboardRows.add(row);
////
////        row = new KeyboardRow();
////        row.add(new KeyboardButton(matchResultList.get(7).getHt()));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(":"));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(matchResultList.get(7).getGt()));
////        keyboardRows.add(row);
////
////        row = new KeyboardRow();
////        row.add(new KeyboardButton(matchResultList.get(8).getHt()));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(":"));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(matchResultList.get(8).getGt()));
////        keyboardRows.add(row);
////
////        row = new KeyboardRow();
////        row.add(new KeyboardButton(matchResultList.get(9).getHt()));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(":"));
////        row.add(new KeyboardButton("-"));
////        row.add(new KeyboardButton(matchResultList.get(9).getGt()));
////        keyboardRows.add(row);
////
////        keyboardMarkup.setKeyboard(keyboardRows);
////        message.setReplyMarkup(keyboardMarkup);
